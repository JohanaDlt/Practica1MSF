...
#colores en el grafico
clr = np.array([0.93,0.64,0.35])
clr2 = np.array([0.23,0.67,0.20])
clr6 = np.array([1.00,0.29,0.76])

_,PAu1 = ctrl.forced_response(sys,t,u1,x0) #nos da un arreglo de dos dimensiones
...
fg2 = plt.figure()
plt.plot(t,u2,'-',color = clr,label = 'Ve(t)')
...
fg3 = plt.figure()
plt.plot(t,u3,'-',color = clr,label = 'Ve(t)')
